...
int main() {
	// Part 1. Randomize numbers.
	srand(time(NULL));
	vector<int> numbers = { (rand() % 10) , (rand() % 10) , (rand() % 10) , (rand() % 10) };
	
	// Part 2. Excepting the repeats
	...
	//Part 3. Cheking for availability repeats.
	...
	do
	{
		...
		//Part 4.3 How many bulls and cows.
		int bull_1 = 0;
		int cows_2 = 0;
		for (int i = 0; i < 4; i++)
		{
